...
import { RegisterInput, LoginInput, registerSchema, loginSchema } from "../schema/auth.schema";
import { signJwt } from "../util/jwt";

const authHandler = express.Router();

authHandler.post("/register", validateSchema(registerSchema),
...
authHandler.post("/login", validateSchema(loginSchema),
